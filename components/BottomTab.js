...
export default function BottomTab () {
  ...
  return (
    <View style={{ flexDirection: "row", alignItems: "center",justifyContent:"space-between" , margin:10,marginHorizontal:30 }}>
    ...
    return (
      <TouchableOpacity>
        <View style={{alignItems:"center"}}>
          <Ionicons style={{marginBottom:3}} name={props.name} size={24}></Ionicons>
